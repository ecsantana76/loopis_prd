      ...
      {isOpen && (
        <div className="app-modal-backdrop fixed inset-0 z-50 flex items-end justify-center p-0 sm:items-center sm:p-4">
          ...
          <motion.div
            ...
            className="app-modal-panel relative z-10 w-full max-w-md overflow-x-hidden overflow-y-auto rounded-t-3xl border border-white/10 bg-brand-graphite p-4 text-white shadow-2xl sm:rounded-3xl sm:p-8"
          >
            {/* Close Button */}
            <button
              type="button"
