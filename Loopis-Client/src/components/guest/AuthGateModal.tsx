...
export const AuthGateModal: React.FC<AuthGateModalProps> = ({
  ...
  return (
    <AnimatePresence>
      <div className="app-modal-backdrop fixed inset-0 z-50 flex items-end justify-center overflow-hidden p-0 sm:items-center sm:p-6">
        {/* Backdrop */}
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        <motion.div
          ...
          className="app-modal-panel relative z-10 w-full max-w-lg overflow-x-hidden overflow-y-auto rounded-t-3xl border border-gray-100 bg-white shadow-2xl dark:border-white/10 dark:bg-brand-graphite sm:rounded-3xl"
        >
          {/* Top Decorative Header with Restaurant Cover Image or Gradient */}
