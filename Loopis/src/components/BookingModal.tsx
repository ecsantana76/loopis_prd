...
export const BookingModal: React.FC<BookingModalProps> = ({ isOpen, onClose, restaurant }) => {
  ...
  const { createReservation } = useStore();
      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="partner-modal-panel fixed bottom-0 left-0 right-0 z-50 overflow-x-hidden overflow-y-auto rounded-t-3xl bg-white dark:bg-brand-graphite"
          >
            <div className="p-6">
              {/* Drawer Handle */}
